...
| --- | --- | --- | --- |
| MSAL Python | Microsoft public-client authorization-code login, PKCE, token acquisition and refresh | [AzureAD/microsoft-authentication-library-for-python](https://github.com/AzureAD/microsoft-authentication-library-for-python) | MIT |
| Microsoft Authentication Extensions for Python | DPAPI-encrypted, lock-aware MSAL cache persistence on Windows | [AzureAD/microsoft-authentication-extensions-for-python](https://github.com/AzureAD/microsoft-authentication-extensions-for-python) | MIT |
| IMAPClient | Parsed UID-based IMAP operations over TLS | [mjs/imapclient](https://github.com/mjs/imapclient) | BSD-3-Clause |
| APScheduler | Single-process periodic mailbox polling | [agronholm/apscheduler](https://github.com/agronholm/apscheduler) | MIT |
...
| HTTPX | Bounded Microsoft Graph HTTP GET requests | [encode/httpx](https://github.com/encode/httpx) | BSD-3-Clause |
...
The project wraps these libraries with a deliberately narrower interface: Graph exposes only message delta/body GET calls, the IMAP connector exposes no mutation primitive, and secure-storage failures never fall back to plaintext.
